...
<html>
    ...
    <script>
        ...
        $(document).ready(function () {
            var url = 'staff/medicalRecordList/${staff.staffId}/page_key_word';
        ...
        function medicalRecordTableInfo(data) {
            ...
            $.each(data, function (index, medicalRecord) {
                var str = "<tr id=" + medicalRecord.medicalRecordId + ">\n\
                   <td style='width:100px;'>" + medicalRecord.medicalRecordId + "</td><td>${staff.staffName}</td>\n\
                   ...
                   <td style='width:100px;'> <a  class='ui button small blue' href='staff/precautionAdviceEdit/" + medicalRecord.medicalRecordId + "'>查看</a> </td>\n\</tr>";
        ...
        function getMedicalRecordItemNumber() {
            var itemNum = 0;
            $.ajax({
                url: "staff/medicalRecordListItemNumber/${staff.staffId}",
                type: 'POST',
                async: false,
                data: {},
