            ...
            <div class="ui segment">
                ...
                <form id="myForm" class="ui form">
                    ...
                    <div class="field">
                        ...
                        <div class="ui input ">
                            <textarea id="introduction" placeholder="请输入员工简介" name="introduction" value="${staff.introduction}">
                                ${staff.introduction}
                            </textarea>
                        </div>
                    </div>
                    <div class="ui placeholder segment">
                        <div class="ui center aligned icon header">
                            <c:if test="${not empty staff.image.imagePath}">
                                <img id="avatar" class="ui centered circular image" src="${staff.image.imagePath}">
                            </c:if>
                            <c:if test="${empty staff.image.imagePath}">
                        ...
                        <center>
                            ...
                            <input id="imagePath" type="text" style="display:none" name="image.imagePath" value="${staff.image.imagePath}">
                        </center>
