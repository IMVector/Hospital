        ...
        <div class="ui container">
            <div class="ui segment">
                ...
                <form id="myForm" class="ui form">
                      <input name="staffWork" type="text" style="display: none" value="${examStaff.staffWork}">
                    <input type="text" name="staffId" value="${examStaff.staffId}" style="display:none">
                    <div class="field">
                        <label for="">员工邮箱：</label>
                        <div class="ui input ">
                            <input id="email" name="email" readonly placeholder="请输入员工邮箱" type="text" value="${examStaff.email}">
                        </div>
                    </div>
                    <div class="field">
                    ...
                    <div class="field">
                        ...
                        <div class="ui input ">
                            <input id="staffName" name="staffName" placeholder="请输入员工姓名" type="text" value="${examStaff.staffName}">
                        </div>
                    </div>
                    <div class="field">
                        <label for="">员工性别：</label>
                        <div class="ui selection dropdown">
                            <input type="hidden" name="gender" value="${examStaff.gender}">
                    ...
                    <div class="field">
                        ...
                        <div class="ui input ">
                            <select id="staffTitleInfo"  name="title.titleId" class="ui fluid dropdown" value="${examStaff.title.titleId}"></select>
                        </div>
                    </div>
                    <div class="field">
                        <label for="">所属部门：</label>
                        <div class="ui input ">
                            <select id="departmentId" name="department.departmentId" class="ui fluid dropdown" value="${examStaff.department.departmentId}"></select>
                        </div>
                    </div>
                    <div class="field">
                        <label for="">员工角色：</label>
                        <div class="ui input ">
                            <select id="roleId" name="role.roleId" class="ui fluid dropdown" value="${examStaff.role.roleId}"></select>
                        </div>
                    </div>
                    <div class="field">
                        <label for="">员工擅长领域：</label>
                        <div class="ui input ">
                            <input id="specialty" name="specialty" placeholder="请输入员工擅长领域" type="text" value="${examStaff.specialty}">
                        </div>
                    </div>
                    <div class="field">
                        <label for="">员工简介：</label>
                        <div class="ui input ">
                            <textarea id="introduction" placeholder="请输入员工简介" name="introduction" value="${examStaff.introduction}">
                                ${examStaff.introduction}
                            </textarea>
                        </div>
                    </div>
                    <div class="ui placeholder segment">
                        <div class="ui center aligned icon header">
                            <c:if test="${not empty examStaff.image.imagePath}">
                                <img id="avatar" class="ui centered circular image" src="${examStaff.image.imagePath}">
                            </c:if>
                            <c:if test="${empty examStaff.image.imagePath}">
                        ...
                        <center>
                            ...
                            <input id="imagePath" type="text" style="display:none" name="image.imagePath" value="${examStaff.image.imagePath}">
                        </center>
        ...
        function requestTitleList(id) {
            ...
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    $("#staffTitleInfo").val(${examStaff.title.titleId});
                },
                error: function (jqXHR, textStatus, errorThrown) {
                    toastError("请求失败,请重试！");
                }
        ...
        function requestDepartmentList(id) {
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    $("#departmentId").val(${examStaff.department.departmentId});
        ...
        function requestRoleList(id) {
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    $("#roleId").val(${examStaff.role.roleId});
                },
                error: function (jqXHR, textStatus, errorThrown) {
                    toastError("请求失败,请重试！");
                }
